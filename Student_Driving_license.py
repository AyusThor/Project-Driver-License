...
def mylicense():
    ...
    address_value = "Vishwajeet Meadows Near Green City ambarnath (east)"
    print(type(address_value))
    vehicle_value = "Four Wheeler"
    print(type(vehicle_value))
    label_id["text"] = id_value
    label_name["text"] = name_value
    label_dob["text"] = dob_value
    label_pin["text"] = pin_value
    label_address["text"] = address_value
    label_vehicle["text"] = vehicle_value
